...
public class CarWash
{
     ...
     */
     public LinkedList<String> getResults()
     {
         ...
         final String AVG_QUEUE_LENGTH ="\nThe average queue length was";
         final String REJECTS= "\nThe number of cars rejected";
         ...
         if (numberOfCars == 0)
              ...
              results.add(AVG_QUEUE_LENGTH + Double.toString
            		  ((Math.round (sumOfWaitingTimes / currentTime * 10)/10.0)));
              results.add(REJECTS +reject);
              
         }
         
         return results;
     } // method getResults
     protected int getTime (int mst)
     {
        double randomDouble = random.nextDouble();

        return (int)Math.round (-mst*Math.log (1 - randomDouble));
     }
